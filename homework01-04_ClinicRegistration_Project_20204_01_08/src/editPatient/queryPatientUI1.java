...
public class queryPatientUI1 extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					queryPatientUI1 frame = new queryPatientUI1();
	...
	public queryPatientUI1() {
		...
		JLabel lblNewLabel_2 = new JLabel("查詢個人資料");
		...
		id_card.setBounds(279, 214, 226, 30);
